...
Usage:
  python scripts/generate_stats_leaderboards.py --players-dir ./docs/players_atp --out-dir ./docs/leaderboards --players-csv ./player_data_atp.csv
"""
import os
import glob
import json
...
def main():
    ...
    ap.add_argument("--players-csv", default="./player_data_atp.csv", help="CSV file mapping player_id -> full_name (header contains full_name and player_id)")
    args = ap.parse_args()
