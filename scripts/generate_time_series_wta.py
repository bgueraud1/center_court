...
Usage:
  python generate_timeseries_from_stats.py --stats-dir /path/to/players --out-dir ./dist --limit-players 200 --player rafael-nadal
"""
import argparse
import os
import glob
...
if __name__ == "__main__":
    ...
    ap.add_argument("--stats-dir", default="./players", help="Directory with player stats JSON files")
